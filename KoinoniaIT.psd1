...
FunctionsToExport = 'Add-AllowedDmaDevices', 'Add-BluredPillarBars', 'Add-GroupEmail', 
               ...
               'Get-BiosProductKey', 'Get-BitlockerStatus', 'Get-ExchangePhoto', 
               'Get-FirmwareType', 'Get-GroupMembershipReport', 'Get-ipPhone', 
               'Get-LapsInfo', 'Get-MailboxAddresses', 'Get-MemoryType', 
               ...
               'Grant-Matching', 'Initialize-OneDrive', 'Initialize-Workstation', 
               'Install-GCPW', 'Install-MicrosoftOffice', 'Install-RSAT', 
               'Invoke-TickleMailRecipients', 'Measure-AverageDuration', 
               'Move-ArchiveEventLogs', 'New-RandomCharacters', 'New-RandomPassword', 
               ...
               'Set-Owner', 'Set-RoomCalendarPermissions', 
               'Set-WindowsAccountAvatar', 'Show-BitlockerEncryptionStatus', 
               'Start-KioskApp', 'Start-PaperCutClient', 'Stop-ForKey', 'Test-Admin', 
               'Test-DmaDevices', 'Test-ScriptMetadata', 'Test-Scripts', 'Test-VoipMs', 
