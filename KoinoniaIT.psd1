...
FunctionsToExport = 'Add-AllowedDmaDevices', 'Add-BluredPillarBars', 
               ...
               'Get-BitlockerStatus', 'Get-DuplicateFileNames', 
               'Get-ExchangeOnlineConnection', 'Get-ExchangePhoto', 
               'Get-FirmwareType', 'Get-GroupMembershipReport', 'Get-ipPhone', 
               'Get-LapsInfo', 'Get-MailboxAddresses', 'Get-MemoryType', 
               'Get-MfpEmails', 'Get-NewComputerName', 'Get-NewIP', 'Get-OrphanedGPO', 
               ...
               'Search-Registry', 'Set-AdPhoto', 'Set-AzureAdPhoto', 
               'Set-ComputerName', 'Set-DefaultWallpapers', 'Set-ExchangePhoto', 
               'Set-Owner', 'Set-RoomCalendarPermissions', 'Set-Wallpaper', 
