...
FunctionsToExport = 'Add-AllowedDmaDevices', 'Add-BluredPillarBars', 
               ...
               'Enable-AdUserPermissionInheritance', 'Enable-LicenseOptions', 
               ...
               'Get-VantagepointEmployee', 'Get-VantagepointInactiveEmployeeUsers', 
               'Get-VantagepointToken', 'Get-VantagepointUsers', 'Get-Wallpaper', 
               'Grant-Matching', 'Import-FortiClientConfig', 'Import-Ipam', 
               'Initialize-BiosUsbKey', 'Initialize-OneDrive', 
               'Initialize-Workstation', 'Install-GCPW', 'Install-MicrosoftOffice', 
               'Install-RSAT', 'Install-WingetFromCsv', 'Invoke-CommandSimple', 
               'Invoke-TickleMailRecipients', 'Invoke-TouchFile', 
               'Measure-AverageDuration', 'Move-ArchivedEventLogs', 
               'Move-ArchiveEventLogs', 'New-FortiClientConfig', 
               'New-IpamDhcpReservationConfig', 'New-Password', 
